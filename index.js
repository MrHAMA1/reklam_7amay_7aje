...
if (message.content.startsWith("https://discord.gg/")) {
  ...
  message.author.send(` https://discord.gg/MJah6UZTdK`) // لینکی سێرڤەری خۆت لیرە دابنی بە هەتا هەتای بێت
...
client.login("OTE4NjM0NjM4ODc0OTA2NjM0.YbKHLQ.0d45YjTi21vNvOAljvlkfuDUeWs");//تۆکین لێرە دانێ
